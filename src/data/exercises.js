...
const CATS={
  ...
  strength:[{i:'',n:'웨이트',l1:'총 볼륨',u1:'kg',l2:'세트',u2:'sets'},{i:'',n:'맨몸 운동',l1:'시간',u1:'분',l2:null,u2:null},{i:'',n:'크로스핏',l1:'시간',u1:'분',l2:null,u2:null},{i:'',n:'저항 운동',l1:'시간',u1:'분',l2:null,u2:null}],
...
const EXERCISE_LIBRARY = [
  // 가슴 (Chest)
  {i:'',n:'벤치프레스',m:'가슴',e:'바벨'},
  {i:'',n:'인클라인 벤치프레스',m:'가슴',e:'바벨'},
  {i:'',n:'디클라인 벤치프레스',m:'가슴',e:'바벨'},
  ...
  {i:'',n:'펙덱 플라이',m:'가슴',e:'머신'},
  {i:'',n:'머신 체스트 프레스',m:'가슴',e:'머신'},
  {i:'',n:'스미스 머신 벤치프레스',m:'가슴',e:'머신'},
  {i:'',n:'슬로우 푸쉬업',m:'가슴',e:'맨몸'},
  {i:'',n:'스미스 인클라인 프레스',m:'가슴',e:'머신'},
  {i:'',n:'플라이 머신 (단측)',m:'가슴',e:'머신'},
  {i:'',n:'푸쉬업',m:'가슴',e:'맨몸'},
  ...
  {i:'',n:'플레이트 프레스',m:'가슴',e:'플레이트'},
  {i:'',n:'디클라인 머신 프레스',m:'가슴',e:'머신'},
  // 등 (Back)
  {i:'',n:'데드리프트',m:'등',e:'바벨'},
  {i:'',n:'루마니안 데드리프트',m:'등',e:'바벨'},
  {i:'',n:'스모 데드리프트',m:'등',e:'바벨'},
  {i:'',n:'랙 풀',m:'등',e:'바벨'},
  {i:'',n:'바벨 로우',m:'등',e:'바벨'},
  {i:'',n:'펜들레이 로우',m:'등',e:'바벨'},
  {i:'',n:'굿모닝',m:'등',e:'바벨'},
  {i:'',n:'덤벨 로우',m:'등',e:'덤벨'},
  ...
  {i:'',n:'어시스트 풀업',m:'등',e:'머신'},
  {i:'',n:'페이스풀',m:'등',e:'케이블'},
  {i:'',n:'랫풀다운',m:'등',e:'머신'},
  {i:'',n:'와이드 랫풀다운',m:'등',e:'머신'},
  {i:'',n:'리버스 그립 랫풀다운',m:'등',e:'머신'},
  {i:'',n:'티바 로우',m:'등',e:'머신'},
  {i:'',n:'머신 로우',m:'등',e:'머신'},
  {i:'',n:'리버스 펙덱',m:'등',e:'머신'},
  {i:'',n:'백 익스텐션',m:'등',e:'머신'},
  ...
  {i:'',n:'클로즈 풀업',m:'등',e:'맨몸'},
  {i:'',n:'슈퍼맨',m:'등',e:'맨몸'},
  {i:'',n:'시티드 로우 머신',m:'등',e:'머신'},
  {i:'',n:'스트레이트 암 풀다운',m:'등',e:'케이블'},
  {i:'',n:'덤벨 풀오버',m:'등',e:'덤벨'},
  // 하체 (Legs)
  {i:'',n:'스쿼트',m:'하체',e:'바벨'},
  {i:'',n:'프론트 스쿼트',m:'하체',e:'바벨'},
  {i:'',n:'박스 스쿼트',m:'하체',e:'바벨'},
  {i:'',n:'힙 쓰러스트',m:'하체',e:'바벨'},
  ...
  {i:'',n:'레그 프레스',m:'하체',e:'머신'},
  {i:'',n:'핵 스쿼트',m:'하체',e:'머신'},
  {i:'',n:'스미스 스쿼트',m:'하체',e:'머신'},
  {i:'',n:'레그 익스텐션',m:'하체',e:'머신'},
  {i:'',n:'레그 컬',m:'하체',e:'머신'},
  {i:'',n:'시티드 레그 컬',m:'하체',e:'머신'},
  {i:'',n:'스탠딩 레그 컬',m:'하체',e:'머신'},
  {i:'',n:'힙 어브덕션',m:'하체',e:'머신'},
  {i:'',n:'힙 어덕션',m:'하체',e:'머신'},
  {i:'',n:'카프 레이즈',m:'하체',e:'머신'},
  {i:'',n:'스탠딩 카프 레이즈',m:'하체',e:'머신'},
  {i:'',n:'시티드 카프 레이즈',m:'하체',e:'머신'},
  {i:'',n:'글루트 브릿지',m:'하체',e:'맨몸'},
  {i:'',n:'점프 스쿼트',m:'하체',e:'맨몸'},
  {i:'',n:'덤벨 카프 레이즈',m:'하체',e:'덤벨'},
  {i:'',n:'바벨 런지',m:'하체',e:'바벨'},
  {i:'',n:'싱글 레그 프레스',m:'하체',e:'머신'},
  {i:'',n:'레그 프레스 (와이드)',m:'하체',e:'머신'},
  // 어깨 (Shoulders)
  {i:'',n:'오버헤드 프레스',m:'어깨',e:'바벨'},
  {i:'',n:'업라이트 로우',m:'어깨',e:'바벨'},
  {i:'',n:'슈러그',m:'어깨',e:'바벨'},
  {i:'',n:'덤벨 숄더 프레스',m:'어깨',e:'덤벨'},
  {i:'',n:'스탠딩 덤벨 숄더 프레스',m:'어깨',e:'덤벨'},
  {i:'',n:'리버스 팩덱 플라이',m:'어깨',e:'머신'},
  ...
  {i:'',n:'스미스 숄더 프레스',m:'어깨',e:'머신'},
  {i:'',n:'머신 레터럴 레이즈',m:'어깨',e:'머신'},
  {i:'',n:'리버스 펙덱 (어깨)',m:'어깨',e:'머신'},
  {i:'',n:'플레이트 프론트 레이즈',m:'어깨',e:'플레이트'},
  {i:'',n:'덤벨 Y레이즈',m:'어깨',e:'덤벨'},
  {i:'',n:'케이블 프론트 레이즈',m:'어깨',e:'케이블'},
  {i:'',n:'머신 숄더 프레스',m:'어깨',e:'머신'},
  // 팔 (Arms)
  {i:'',n:'바벨 컬',m:'팔',e:'바벨'},
  {i:'',n:'리버스 컬',m:'팔',e:'바벨'},
  {i:'',n:'스컬 크러셔',m:'팔',e:'바벨'},
  {i:'',n:'클로즈그립 벤치프레스',m:'팔',e:'바벨'},
  {i:'',n:'덤벨 컬',m:'팔',e:'덤벨'},
  {i:'',n:'해머 컬',m:'팔',e:'덤벨'},

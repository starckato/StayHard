-- [이관 기록] 원본: supabase/migrations/20260807_agent_act_dispatcher.sql
-- 2026-08-06~07 에 프로덕션 적용 완료된 마이그레이션의 canonical 재배치 (2026-09-14).
-- supabase/migrations/ 는 DEPRECATED 폴더 (README 참고) — 번호 체계는 이 폴더가 기준.
